  ...
  return (
    ...
    <directionalLight  position={[0,3,1]} intensity={0.1}/>
      ...
      <group ref={cameraGroup}>
        ...
        <PerspectiveCamera position={[0,2,8]} fov={40} rotation={[-Math.PI /16 , 0, 0]}   makeDefault/>
        </group>
        <group ref={airplane}>
      ...
      <Model rotation-y={Math.PI} scale={[0.2,0.2,0.2]}  position-z={0.1}/>
